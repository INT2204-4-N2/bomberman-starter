...
public class Sprite {
	...
	public static Sprite minvo_left2 = new Sprite(16, 8, 4, SpriteSheet.tiles, 16, 16);
	public static Sprite minvo_left3 = new Sprite(16, 8, 4, SpriteSheet.tiles, 16, 16);

	public static Sprite minvo_right1 = new Sprite(16, 9, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite minvo_right2 = new Sprite(16, 9, 4, SpriteSheet.tiles, 16, 16);
	public static Sprite minvo_right3 = new Sprite(16, 9, 4, SpriteSheet.tiles, 16, 16);
